 ...
 * ```
 */
export function mapSubscriptionPlanToIcon<
  T extends { subscriptionType: SubscriptionTypeEnum },
>(plan: T): T & { icon: LucideIcon } {
  return {
    ...plan,
 ...
 */
export function mapSubscriptionPlansToIcons<
  T extends { subscriptionType: SubscriptionTypeEnum },
>(plans: T[]): (T & { icon: LucideIcon })[] {
