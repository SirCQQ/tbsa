...
// // Mock StripeService to prevent Stripe initialization
...
describe("OrganizationService", () => {
  ...
  //         "O organizație cu acest cod există deja"
  //       );
  ...
  //       expect(result.success).toBe(false);
  //       expect((result as ErrorServiceResult).error).toBe(
  //         "Eroare la crearea organizației"
  //       );
  //     });
  //   });
  ...
  //       expect(result.success).toBe(false);
  //       expect((result as ErrorServiceResult).error).toBe(
  //         "Planul de abonament nu a fost găsit"
  //       );
  //     });
  ...
  //       mockUserOrganizations as any
  //     );

  //     const result = await OrganizationService.getUserOrganizations(userId);

  //     expect(result.success).toBe(true);
  //     expect(result.data).toEqual(mockUserOrganizations);
  ...
  //     expect(result.success).toBe(false);
  //     expect((result as ErrorServiceResult).error).toBe(
  //       "Eroare la încărcarea organizațiilor utilizatorului"
  //     );
  //   });
});
